...
namespace Location
{
    public static class LocationHelper
    {
        ...
        {
            // MAPSERVICE KEY
            MapService.ServiceToken = "NU84AueM7GMiPBOwHSoE~Ys6Syu5oct7d2PaDIdzl8g~AsQyIrLBonF8di9BqLCV0kg0tZnAFpbav2HztwHXPdUa3JOgL56tMLZP4E2vlTg8";
        }
        ...
        public static async Task UpdateTravelInfoAsync(LocationData location, LocationData currentLocation)
        {
            ...
            if (routeResult.Status == MapRouteFinderStatus.Success)
            {
                ...
                location.CurrentTravelDistance = Math.Round(routeResult.Route.LengthInMeters * 0.001, 1); // convert to km
